...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Skill = __webpack_require__(211);

	var _Skill2 = _interopRequireDefault(_Skill);

	var _Work = __webpack_require__(212);
	...
	ReactDOM.render(React.createElement(_reactRouter.Router, { history: _reactRouter.browserHistory }, React.createElement(_reactRouter.Route, { path: '/', component: _Index2.default }, React.createElement(_reactRouter.Route, { path: 'about', component: _About2.default }), React.createElement(_reactRouter.Route, { path: 'project', component: _Project2.default }), React.createElement(_reactRouter.Route, { path: 'skill', component: _Skill2.default }), React.createElement(_reactRouter.Route, { path: 'work', component: _Work2.default }))), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function (_React$Component) {
	    ...
	    _createClass(Footer, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement("footer", { id: "footer" }, _react2.default.createElement("footer", { id: "footer-bottom" }, _react2.default.createElement("p", { className: "pull-right" }, _react2.default.createElement("a", { href: "#" }, "Back to Top.")), _react2.default.createElement("p", null, "© 2016 Gabriel Rivera Per-ossenkopp's Portfolio")));
	        }
	    }]);
